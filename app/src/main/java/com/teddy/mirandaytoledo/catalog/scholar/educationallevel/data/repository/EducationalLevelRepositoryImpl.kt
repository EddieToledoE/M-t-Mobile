package com.teddy.mirandaytoledo.catalog.scholar.educationallevel.data.repository

import com.teddy.mirandaytoledo.catalog.scholar.educationallevel.data.dto.CreateEducationalLevelRequest
import com.teddy.mirandaytoledo.catalog.scholar.educationallevel.data.dto.UpdateEducationalLevelRequest
...
class EducationalLevelRepositoryImpl(
    ...
    override suspend fun update(
        ...
        return remoteDataSource.update(
            id = id,
            request = UpdateEducationalLevelRequest(
                name = name,
                maxGrade = maxGrade,
                isActive = isActive
            )
